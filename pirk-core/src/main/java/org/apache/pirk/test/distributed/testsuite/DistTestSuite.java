...
public class DistTestSuite
{
  ...
  public static void testJSONInputSparkStreaming(FileSystem fs, List<JSONObject> pirDataElements) throws Exception
  {
    ...
    // Run tests
    BaseTests.testDNSHostnameQuery(pirDataElements, fs, SPARKSTREAMING, true, 1, false);
    BaseTests.testDNSIPQuery(pirDataElements, fs, SPARKSTREAMING, true, 1);
    BaseTests.testSRCIPQuery(pirDataElements, fs, SPARKSTREAMING, true, 3);
    BaseTests.testSRCIPQueryNoFilter(pirDataElements, fs, SPARKSTREAMING, true, 2);
